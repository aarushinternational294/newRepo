...
const ComparisonTable = () => {
   ...
   return (
       <div className="container mx-auto p-8 ">
           <h1 className="text-3xl font-bold mb-4 text-indigo-600 just flex justify-center">
           ...
           <div className="mt-8">
               ...
               <Table>
{/*                    <TableCaption>Services offered by educational consultancies.</TableCaption>
 */}                   <TableHeader>
                       <TableRow>
                           <TableHead className="w-[300px]">Service</TableHead>
                           <TableHead className="text-center">{selectedConsultancy.name}</TableHead>
                   ...
                   <TableBody>
                       {consultancies[0].services.map((service, index) => (
                           <TableRow key={service}>
                               <TableCell className="font-medium">{service}</TableCell>
                               <TableCell className="text-center">
                                   {selectedConsultancy.services.includes(service) ? (
